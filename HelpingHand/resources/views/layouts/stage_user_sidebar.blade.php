<div class="left-sidenav">
    ...
    <div class="menu-content h-100" data-simplebar>
        <ul class="metismenu left-sidenav-menu">
            ...
            @if ($auth_user->hasPermissionTo('Edit-Stage4'))
                
            
   

            <li>
                <a href="{{ route('jobs-applicants-practical_evaluation') }}"><i data-feather="clipboard"
                        class="align-self-center menu-icon"></i><span>Practical Evaluation</span></a>
            ...
            <li>
                ...
                <a href="{{ route("screening_candidates" )}}"><i data-feather="user-plus"
                        class=" align-self-center menu-icon "></i><span>Screening Interview </span> <span class="text-danger"> ({{ $auth_user->interview_date()->where('status',0)->where('is_cancelled',0)->where('interview_date',$today)->count() }})</span></a>
            ...
            @if ($auth_user->hasRole('HR'))
                
            
            <li class="menu-label my-2">HR Manager</li>

            <li>
                <a href="{{ route('jobs-applicants-completed') }}"><i data-feather="check"
                        class="align-self-center menu-icon"></i><span>Stage Review</span></a>
