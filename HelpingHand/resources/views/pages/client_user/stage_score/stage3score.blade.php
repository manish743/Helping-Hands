                            ...
                            <div class="card">
                                <div class="card-header">
                                    @php
                                        ...
                                        if (isset($job_stage_weight[3])) {
                                            $stage1_stage = $job_stage_weight[3]->pluck('stage_weight', 'stage_id')->unique();
                                            $stage1 = $job_stage_weight[3]->pluck('competency_weight', 'competency');
                                        }
                                    @endphp
                                ...
                                @if (in_array(3, $stages))
                                    <div class="card-body mb-2 stage_id"
                                        style="max-height:; overflow-y:auto; visibility:{{ in_array(3, $stages) ? 'visible' : 'hidden' }};"
                                        data-stage="2">
                                        <h4 class="card-title">Hard Skill</h4>
                                        <div class="card-body skill-body" data-type="hard">
                                            @if ($stages_question->has(3))
                                                @foreach ($stages_question[3]->where('competency', 'Hard Skill')->groupBy('competency') as $competency => $competencyQuestions)
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="stage[3][hard][{{ $question->question }}]"
                                    ...
                                    <div class="card-body mb-2 stage_id"
                                        ...
                                        <div class="card-body skill-body" data-type="hard">
                                            @if ($stages_question->has(3))
                                                @foreach ($stages_question[3]->where('competency', 'Soft Skill')->groupBy('competency') as $competency => $competencyQuestions)
                                                    @foreach ($competencyQuestions->groupBy('skill') as $skillId => $skillQuestions)
                                                        <fieldset id="hard" class="field-set"
                                                            data-count="{{ $loop->iteration }}">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="stage[3][soft][{{ $question->question }}]"
                                                                                            class="range_selector">
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <div class="card-body mb-2 stage_id"
                                        ...
                                        <div class="card-body skill-body" data-type="hard">
                                            @if ($stages_question->has(3))
                                                @foreach ($stages_question[3]->where('competency', 'Team Fit')->groupBy('competency') as $competency => $competencyQuestions)
                                                    @foreach ($competencyQuestions->groupBy('skill') as $skillId => $skillQuestions)
                                                        <fieldset id="hard" class="field-set"
                                                            data-count="{{ $loop->iteration }}">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="stage[3][team][{{ $question->question }}]"
                                                                                            class="range_selector">
                                                                                    </div>
                                                                                </div>
