...
@section('create_button')
    <li class="creat-btn">
        <div class="nav-link">
            ...
            <a class=" btn btn-sm btn-soft-success" role="button" data-bs-toggle="modal" data-bs-target="#exampleModalLarge"><i
                    class="fas fa-plus me-2"></i>Send Registration Link Candidate</a>
        </div>
    </li>
@endsection
