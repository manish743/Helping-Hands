...
@section('content')
    ...
    <input required type="number" id="question-weight" class="form-control d-none d-inline question-weight"
    ...
    <form action="{{ route('jobs-store') }}" id="myForm" method="post" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row p-3">
            <div class="col-lg-12">
                <div class="card">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="form-label">Type of job</label>
                                                ...
                                                <select name="job_type" id="job_type" class="select2 form-control mb-3t"
                                ...
                                <div class="form-group">
                                    <label class="form-label">Department / Business Unit</label>
                                        ...
                                        <select name="department" id="department" class="select2 form-control mb-3t"
                                            style="width: 100%; height:36px;" required>
