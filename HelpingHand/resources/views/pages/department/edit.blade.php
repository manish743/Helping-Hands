...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form action="{{ route('department-update') }}" id="myForm" method="post" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="org_id" value="{{base64_encode($department->id)}}">
        <div class="row p-3">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body bootstrap-select-1">
                        ...
                        <button class="btn btn-primary text-white" type="submit">Update Department</button>
                    </div><!-- end card-body -->
