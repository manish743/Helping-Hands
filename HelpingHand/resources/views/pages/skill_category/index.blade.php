                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto align-self-center">
                            ...
                            {{-- <a class=" btn btn-sm btn-soft-primary" href="{{ route('skill_category-add') }}" role="button"><i class="fas fa-plus me-2"></i>New Task</a> --}}
                        </div>
                    </div> <!--end row-->
                </div><!--end card-header-->
                <div class="card-body">
                        ...
                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="border-top-0">Skill Category Name</th>
                                    <th class="border-top-0">Skills (count)</th>
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{ $item->id }}">
                                    ...
                                    <td>{{ $item->name }}</td>                                
                                    <td>{{ count($item->skills) }}</td>                                
                                    <td> <a href="{{ route('skill_category-edit',$item->id) }}" class="btn btn-sm btn-primary text-wgite"><i class="fas fa-pencil-alt me-1"></i> Edit</a>
                                        <a class="skill_category-delete btn btn-sm btn-danger text-white"><i class="far fa-trash-alt me-1"></i>Delete</a></td>
...
<script src="{{ URL::asset('assets/plugins/sweet-alert2/sweetalert2.min.js') }}"></script>
    ...
    <script>
        $('.skill_category-delete').click(function(e) {
            e.preventDefault();
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('skill_category-delete') }}",
                        type: "POST",
                        data: {
