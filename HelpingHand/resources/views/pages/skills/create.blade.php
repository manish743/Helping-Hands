            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Fill The Form below to create new Skills
                        </p>
                    </div><!--end card-header-->
                    <div class="card-body bootstrap-select-1">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="skill_category" id="tagInput" class="form-control" parsley-type="text"
                                            placeholder="names seperated by comma">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="competency" checked id="inlineRadio1" value="Hard Skill">
                                            <label class="form-check-label" for="inlineRadio1">Hard Skill</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="competency" id="inlineRadio2" value="Soft Skill">
                                            <label class="form-check-label" for="inlineRadio2">Soft Skill</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="competency" id="inlineRadio3" value="Team Fit">
                        ...
                        <button class="btn btn-primary text-white" type="submit">Create Skills</button>
                    </div><!-- end card-body -->
