...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form action="{{ route('question-update') }}" id="myForm" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Fill The Form below to  Update new Question
                        </p>
                    </div><!--end card-header-->
                    <div class="card-body bootstrap-select-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="tag-suggestions" class="select2 mb-3 select2-multiple"
                                        ...
                                        @foreach ($skill_list as $item)
                                            ...
                                            <option value="{{ $item }}" @if (in_array($item, $skill_selected)) selected @endif>{{ $item }}
                                            </option>
                                        @endforeach
                        ...
                        <button class="btn btn-primary text-white" type="submit"> Update Question</button>
                    </div><!-- end card-body -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myForm').on('submit', function(event) {
                ...
                //  Update an input element to hold the array of strings
                var input = $('<input>')
                    .attr('type', 'hidden')
                    .attr('name', 'skills')
                    .val(titlesArray);
