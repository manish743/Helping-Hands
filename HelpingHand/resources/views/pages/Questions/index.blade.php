...
@section('create_button')
    <li class="creat-btn">
        <div class="nav-link">
            <a class=" btn btn-sm btn-soft-primary" href="{{ route('question-add') }}" role="button"><i
                    class="fas fa-plus me-2"></i>New Question</a>
        </div>
    </li>
@endsection
        ...
        <div class="col-lg-12">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto align-self-center">
                            ...
                            {{-- <a class=" btn btn-sm btn-soft-primary" href="{{ route('question-add') }}" role="button"><i class="fas fa-plus me-2"></i>New Question</a> --}}
                        </div>
                    </div> <!--end row-->
                </div><!--end card-header-->
                <div class="card-body">
                        ...
                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="border-top-0">Skills(Applied For)</th>                    
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{ $item->id }}">
                                    ...
                                    <a class="question-delete btn btn-sm btn-danger text-white"><i
            ...
            <div class="card m-2">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title"> Questions By Client</h4>
                        </div><!--end col-->
                        <div class="col-auto align-self-center">
                ...
                <div class="card-body">
                    <div class="">
                        <table id="datatable2"   class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @foreach ($client_question as $item)
